...
$("#userid").attr('value', userid);
	...
	$.ajax({
		...
		success: function(result){
				...
				var res= '  <form method="post" action="update_user.php">' +
				'<div class="modal-header">' +
 ...
 '<div class="modal-body">' +
         ...
         ' <div class="form-group">' +
          ...
          '  <input type="text" class="form-control" required type="text" name="name" placeholder="John" value="'+result.users.name+'">' +
          '</div>' +
         ' <div class="form-group">' +
           ' <label for="message-text" class="col-form-label">Last name</label>' +
			'<input type="text" class="form-control" required type="text" name="username" placeholder="John" value="'+result.users.surname+'">'  +
         ' </div>' +
		'	<div class="form-group">' +
...
'<div class="form-group">' +
    ...
    '  </div>' +
   '   <div class="modal-footer">' +
'<input id="userid" name="userid" type="hidden" value="'+result.users.id[0]+'">' +
